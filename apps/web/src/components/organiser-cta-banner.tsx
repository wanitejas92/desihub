...
export function OrganiserCtaBanner() {
  return (
    <section className="max-w-content mx-auto px-4 py-6 sm:px-6">
      <div className="shadow-elevation-lg relative overflow-hidden rounded-lg">
        <CtaBannerIllustration className="absolute inset-0" />
        <div className="relative flex flex-col items-start gap-5 p-6 pb-14 sm:flex-row sm:items-center sm:justify-between sm:p-8 sm:pb-16">
