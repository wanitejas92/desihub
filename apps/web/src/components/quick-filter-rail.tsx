...
import { IconTicket, IconCalendar, IconDisco, IconSparkle, IconChevronRight } from './ui/icons';
...
/**
 * Quick filters + a static grid beneath, as one interactive unit: clicking a
